window.WashHistoryUI = (function(){
  ...
  function renderDetail(record){
    ...
    return `<div class="historial-detail-body">
      ...
      <div class="historial-detail-actions"><button class="historial-btn" onclick="WashHistory.sendTasksToManager('${esc(record.id)}')">Enviar tareas al gestor</button><button class="historial-btn secondary" onclick="WashHistory.copyDetail('${esc(record.id)}')">Copiar detalle</button><button class="historial-btn secondary" onclick="WashHistory.toggleFavorite('${esc(record.id)}')">${record.isFavorite?'★':'☆'} Favorito</button></div>
    </div>`;
  }
